  ...
  return (
    <SafeAreaView className='bg-primary h-full'>
      <ScrollView className='px-4 my-6'>
        ...
        <FormField 
          title={'Video title'} value={form.title} placeholder={'Give your video a catchy title...'}
          ...
          <FormField 
          title={'AI Prompt'} value={form.prompt} placeholder={'The propt ypu used to create thos video'}
